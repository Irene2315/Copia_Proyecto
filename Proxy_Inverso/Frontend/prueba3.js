...
function construccionCards() {
    ...
    var formatoFecha_2 = (f.getFullYear() + "" + formatearNumeroConCero(f.getMonth() + 1) + "" + formatearNumeroConCero(f.getDate()));
    console.log("fecha_2");
                ...
                data.forEach(itemsLugarSelectAhora => {
                    ...
                    let promesa = fetch(peticionActual.consulta, options)
                        ...
                        .then(data => {
                            ...
                            construirCards += `<div class="card" data-toggle="tooltip" title="${respuestaConsulta}" >`;
